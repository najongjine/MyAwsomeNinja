...
public class Skill_PrefabGenerator : MonoBehaviour
{
    ...
    bool allRotationDecided = false;

    float x_Cur, y_Cur, z_Cur;
    float x_RotCur, y_RotCur, z_RotCur;
    ...
    void Start()
    {
        ...
        // define interval time of prefab generator
    ...
    void Update()
    {
        ...
        if (timeCounter > trigger && effectCounter <= thisManyTimes)
        {
            ...
            var skill = Instantiate(skillPrefabs[randNum], new Vector3(x_Cur, y_Cur, z_Cur), transform.rotation);
